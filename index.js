  ...
  if (textAreaEl.value) {
    ...
    fetch("https://api.openai.com/v1/edits", {
      ...
      body: JSON.stringify({
        ...
        instruction:
          "Fix all of the grammar, always add the correct punctuation and always correct spelling mistakes. Do not go to the next line after making corrections to the input text.",
        n: 1,
        temperature: 0.2,
      }),
    })
